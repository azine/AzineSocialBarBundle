...
class SocialBarTwigExtension extends \Twig_Extension
{
    ...
    {
        $functions = array();
        $functions['socialButtons'   ] = new \Twig_SimpleFunction('socialButtons'   , 'getSocialButtons', array('is_safe' => array('html')));
        $functions['facebookButton'  ] = new \Twig_SimpleFunction('facebookButton'  , 'getFacebookButton', array('is_safe' => array('html')));
        $functions['twitterButton'   ] = new \Twig_SimpleFunction('twitterButton'   , 'getTwitterButton', array('is_safe' => array('html')));
        $functions['googlePlusButton'] = new \Twig_SimpleFunction('googlePlusButton', 'getGooglePlusButton', array('is_safe' => array('html')));
        $functions['xingButton'      ] = new \Twig_SimpleFunction('xingButton'      , 'getXingButton', array('is_safe' => array('html')));
        $functions['linkedInButton'  ] = new \Twig_SimpleFunction('linkedInButton'  , 'getLinkedInButton', array('is_safe' => array('html')));
        return $functions;
    }
